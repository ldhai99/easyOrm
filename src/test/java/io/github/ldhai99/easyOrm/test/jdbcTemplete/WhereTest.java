...
public class WhereTest {
    ...
    public void where() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").where("age=18").getMaps()
        );
    }
    //等于------------------------------------
    @Test
    ...
    public void eqString() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").eq("name", "李四").getMaps()
        );
    }
    //不等于------------------------------------
    @Test
    public void neq() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").neq("age", 18).getMaps()
        );
    }
    //大于------------------------------------
    @Test
    public void gt() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").gt("age", 18).getMaps()
        );
    }
    //大于等于------------------------------------
    @Test
    public void gte() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").gte("age", 18).getMaps()
        );
    }
    //小于------------------------------------
    @Test
    public void lt() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").lt("age", 18).getMaps()
        );
    }
    //小于等于------------------------------------
    @Test
    public void lte() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").lte("age", 18).getMaps()
        );
    }
    //中间一致------------------------------------
    @Test
    public void like() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").like("name", "李").getMaps()
        );
    }
    //中间不一致------------------------------------
    @Test
    public void notLike() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").notLike("name", "李").getMaps()
        );
    }
    //后方一致------------------------------------
    @Test
    public void likeLeft() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").likeLeft("name", "三").getMaps()
        );
    }
    //前方一致------------------------------------
    @Test
    public void likeRight() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").likeRight("name", "李").getMaps()
        );
    }
    //占位一致------------------------------------
    @Test
    public void like_() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").like_("name", "李__").getMaps()
        );
    }
    //范围查询------------------------------------
    @Test
    public void between() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").between("age", 18,20).getMaps()
        );
    }
    //范围以外------------------------------------
    @Test
    public void notbetween() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").notBetween("age", 18,20).getMaps()
        );
    }
    ...
    public void isNull() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").eq("age",18).isNull("name").getMaps()
        );
    }
    @Test
    public void isNotNull() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").eq("age",18).isNotNull("name").getMaps()
        );
    }
    //是or in------------------------------------
    @Test
    public void or() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").eq("age",18).or().eq("age",19).or().eq("age",17).getMaps()
        );
    }
    @Test
    ...
    public void last() throws SQLException {
        ...
        System.out.println(
                new SQL(executor).select("student").column("name,age").orderBy("age").last(" limit 0,2").getMaps()
        );
    }
